(function () {
    ...
    angular.module('tracker').factory('earth', function () {
        /* global satellite */
        //earth.js
        var earth = {};
        ...
        earth.init = function() {
          ...
          img.src = '/stylesheets/images/mercator-tex.jpg';
        //  img.src = '/mercator-tex-512.jpg';
          ...
          nightImg.src = '/stylesheets/images/nightearth-4096.png';
         ...
         //   console.log('LAT: ' + latAngle * R2D + ' , Z: ' + z);
          ...
          var vertIndex = [];
          for(var lat1=0; lat1 < NUM_LAT_SEGS; lat1++) { //this is for each QUAD, not each vertex, so <
            for(var lon1=0; lon1 < NUM_LON_SEGS; lon1++) {
              var blVert = lat1 * (NUM_LON_SEGS+1) + lon1; //there's NUM_LON_SEGS + 1 verts in each horizontal band
              var brVert = blVert + 1;
              var tlVert = (lat1 + 1) * (NUM_LON_SEGS+1) + lon1;
              var trVert = tlVert + 1;
